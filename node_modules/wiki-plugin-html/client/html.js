...
builtins = {
  'http://new_page/': function httpNew_page(params) {
    return {
      "title": params.title,
      "story": [{
        "id": "98234090910324",
...
emit = function emit($item, item) {
  return $item.append("<p>".concat(wiki.resolveLinks(item.text, sanitize), "</p>"));
};
...
bind = function bind($item, item) {
  ...
  $item.find('input').dblclick(function (e) {
  ...
  return $item.on('submit', function (e) {
    ...
    e.preventDefault();
    params = {};
    $item.find('form').serializeArray().map(function (obj) {
...
},{"@mapbox/sanitize-caja":2}],2:[function(require,module,exports){
